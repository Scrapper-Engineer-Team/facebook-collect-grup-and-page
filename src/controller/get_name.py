...
class GrupName:
    def __init__(self):
        ...
        self.headers = {
            ...
            'priority': 'u=1, i',
            'referer': 'https://www.facebook.com/search/top?q=jual%20beli&locale=id_ID',
